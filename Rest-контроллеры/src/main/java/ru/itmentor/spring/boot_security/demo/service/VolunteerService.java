...
public interface VolunteerService { // Объявление интерфейса VolunteerService
    ...
    void createVolunteer(Volunteer volunteer); // Метод для создания волонтера

    void updateVolunteer(Volunteer volunteer); // Метод для обновления информации о волонтере
}
