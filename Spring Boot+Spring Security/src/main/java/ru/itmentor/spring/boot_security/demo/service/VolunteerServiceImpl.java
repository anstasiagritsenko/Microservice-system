...
public class VolunteerServiceImpl implements VolunteerService { // Объявление класса VolunteerServiceImpl, реализующего интерфейс VolunteerService
    ...
    private void createVolunteer(Volunteer volunteer) { // Объявление приватного метода createVolunteer с параметром volunteer
        volunteerDao.createVolunteer(volunteer); // Вызов метода createVolunteer из volunteerDao
    }

    private void updateVolunteer(Volunteer volunteer) { // Объявление приватного метода updateVolunteer с параметром volunteer
